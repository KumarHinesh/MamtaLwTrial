...
public class FormCrf2DTO {
    ...
    private List<ChildWeightDTO> childWeights;
    private List<ArmReadingDTO> armReadings;
    ...
    public List<ChildWeightDTO> getChildWeights() {
        return childWeights;
    }

    public void setChildWeights(List<ChildWeightDTO> childWeights) {
        this.childWeights = childWeights;
    }

    public List<ArmReadingDTO> getArmReadings() {
        return armReadings;
    }

    public void setArmReadings(List<ArmReadingDTO> armReadings) {
        this.armReadings = armReadings;
    }
